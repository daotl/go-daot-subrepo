...
func (d *Failstore) Put(ctx context.Context, k key.Key, val []byte) error {
	err := d.errfunc("put")
	if err != nil {
		return err
	}
...
func (d *Failstore) Sync(ctx context.Context, prefix key.Key) error {
	err := d.errfunc("sync")
	if err != nil {
		return err
	}
...
func (d *Failstore) Get(ctx context.Context, k key.Key) ([]byte, error) {
	err := d.errfunc("get")
	if err != nil {
		return nil, err
	}
...
func (d *Failstore) Has(ctx context.Context, k key.Key) (bool, error) {
	err := d.errfunc("has")
	if err != nil {
		return false, err
	}
...
func (d *Failstore) GetSize(ctx context.Context, k key.Key) (int, error) {
...
func (d *Failstore) Delete(ctx context.Context, k key.Key) error {
...
func (b *FailBatch) Put(ctx context.Context, k key.Key, val []byte) error {
...
func (b *FailBatch) Delete(ctx context.Context, k key.Key) error {
